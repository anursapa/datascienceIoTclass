...
ad = spark.read.csv("C:/6290Internetofthings/Advertising.txt", header=True, inferSchema=True)
ad.show(5)
...
data = spark.read.csv("C:/6290Internetofthings/Ecommerce_Customers.txt",inferSchema=True,header=True)
data.show(5)
data.columns

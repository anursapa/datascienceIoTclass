...
# ## Import data
cuse = spark.read.csv("C:/6290Internetofthings/lecture6/cuse_binary.txt", header=True, inferSchema=True)
cuse.show(5)
...
# In[6]:
# #### Second Example
data = spark.read.csv("C:/6290Internetofthings/lecture6/titanic.tx"',inferSchema=True,header=True)
